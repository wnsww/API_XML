...
public class CopyOfPagination {
	...
	public CopyOfPagination() {}
	
	public CopyOfPagination(int page, int totalCount, String url) {
		this.setPage(page);
	...
	public String getPagination() {
		...
		System.out.println(this.getBlockEnd());
		...
		buffer.append("</div>");
		System.out.println(this.getBlockStart()+"//"+this.getBlockEnd()+"/"+endPage);
	...
	private int getBlockEnd() {
		...
		System.out.println("getBlockEnd : "+this.endPage);
